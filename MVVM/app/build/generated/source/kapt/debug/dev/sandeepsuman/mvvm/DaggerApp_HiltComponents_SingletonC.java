...
import dev.sandeepsuman.mvvm.injection.NetworkModule_ProvideRepoFactory;
import dev.sandeepsuman.mvvm.injection.NetworkModule_ProvideRetrofitClientFactory;
import dev.sandeepsuman.mvvm.ui.view.MainActivity;
import dev.sandeepsuman.mvvm.ui.vm.PersonViewModel;
import dev.sandeepsuman.mvvm.ui.vm.PersonViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC extends App_HiltComponents.SingletonC {
  ...
  private Provider<PersonRepo> provideRepoProvider;
  ...
  private PersonRepo personRepo() {
    return NetworkModule_ProvideRepoFactory.provideRepo(networkModule, provideRetrofitClientProvider.get());
  }

  @SuppressWarnings("unchecked")
  private void initialize(final ApplicationContextModule applicationContextModuleParam,
      final NetworkModule networkModuleParam) {
    this.provideRetrofitClientProvider = DoubleCheck.provider(new SwitchingProvider<APIClient>(singletonC, 1));
    this.provideRepoProvider = DoubleCheck.provider(new SwitchingProvider<PersonRepo>(singletonC, 0));
  }
  ...
  public static final class Builder {
    ...
    public App_HiltComponents.SingletonC build() {
      ...
      return new DaggerApp_HiltComponents_SingletonC(applicationContextModule, networkModule);
    }
  }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private PersonViewModel personViewModel() {
      return new PersonViewModel(singletonC.provideRepoProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      this.personViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("dev.sandeepsuman.mvvm.ui.vm.PersonViewModel", (Provider) personViewModelProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // dev.sandeepsuman.mvvm.ui.vm.PersonViewModel 
          return (T) viewModelCImpl.personViewModel();
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // dev.sandeepsuman.mvvm.data.repo.PersonRepo 
        return (T) singletonC.personRepo();

        case 1: // dev.sandeepsuman.mvvm.data.api.APIClient 
        return (T) NetworkModule_ProvideRetrofitClientFactory.provideRetrofitClient(singletonC.networkModule);
